        ...
        if username == "admin":
            ...
            with open("user.txt", "r") as f:
                ...
                while new_user in usernames:
                    ...
                    new_user = str(
                        input(
                            "Username already in use, please try a different name: \n"
                        )
                    )
                    continue
            ...
            print(
                "You are not authorised to add new users. Please contact your system administrator."
            )
...
def add_task(user_input):
    ...
    if user_input.lower() == "a":
        ...
        user = str(
            input("Please input the username of the person assigned to this task: ")
        )
...
def view_mine(user_input):
    ...
    if user_input.lower() == "vm":
        ...
        task_select = int(
            input(
                'Please enter a task number to edit, or type "-1" to return to the main menu: '
            )
        )
        ...
        if complete.lower() == "y":
            ...
            if temp_list[5] == " No":
                ...
                edit_select = input(
                    'Would you like to edit the user assigned to this task or the due date? Please enter "new" or "due": '
                )
                ...
                if edit_select.lower() == "new":
                    ...
                    new_user = str(
                        input(
                            "Please enter the name of the user you wish to reassign the task to: "
                        )
                    )
...
def generate_reports():
    ...
    with open(
        "user.txt", "r"
    ) as f2:  # same as previous block, counting number of users
        for line in f2:
            num_users += 1
